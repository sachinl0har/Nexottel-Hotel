        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li>
                <a class="dropdown-item" href="#">HOTEL MANAGEMENT</a>
              </li>
              <li>
                <a class="dropdown-item" href="#">HUMAN RESOURCE AND TRAINING</a>
              </li>
              <li>
                <a class="dropdown-item" href="#">PROPERTY DEVELOPMENT</a>
              </li>
              <li>
                <a class="dropdown-item" href="#">SALES, MARKETING & REVENUE MANAGEMENT</a>
              </li>
              <li>
                <a class="dropdown-item" href="#">BRAND COMPLIANCE</a>
              </li>
              <li>
                <a class="dropdown-item" href="#">FINANCE AND ACCOUNTING</a>
              </li>
              <li>
                <a class="dropdown-item" href="#">DESIGN MANAGEMENT</a>
              </li>
              <li>
                <a class="dropdown-item" href="#">TECHNICAL SERVICES</a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
          ...
          <div class="info">
            <div class="address">
              ...
              <p>
                ...
                <br>
                Pune - Solapur Road, Manjari bk, Phursungi Phata,
                <br>
                Pune - 412307
              </p>
              <p>
                <b>Branch office :-</b>
                <br>
                396/191 Moo 12, Pratyumnk, Nongprue, Banglamung, Chonburi (Pattaya),
                <br>
                Thailand - 20150
              </p>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 col-lg-4 footer-about wow fadeInUp">
              <img class="logo-footer" src="assets/img/LOGO-1.png" alt="logo-footer" data-at2x="assets/img/LOGO-1.png">
              <p>
                Hotels worldwide incl. Infos, Ratings and Photos. Make your Hotel Reservation cheap.
                <br>
            ...
            <div class="col-md-4 col-lg-4 offset-lg-1 footer-contact wow fadeInDown">
              ...
              <p>
                <i class="fa fa-map-marker"></i> Corporate office :- Manjari bk, Phursungi Phata, Pune - 412307
                <br>
                Branch office :- 396/191 Moo 12, Pratyumnk, Nongprue, Banglamung, Chonburi (Pattaya), Thailand - 20150
              </p>
              <p>
                <i class="fa fa-phone"></i> Phone: +91 9922-972-137
              </p>
              <p>
                <i class="fa fa-envelope"></i> Email: <a href="mailto:hello@domain.com">info@nexottel.com</a>
              </p>
            </div>
