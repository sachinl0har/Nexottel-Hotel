...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
  ...
  <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="main container text-center py-3">
        ...
        <div class="row">
            <div class="col-md-6 form-group mt-3">
            <input class="form-control" type="text" name="department" placeholder="F & B Service">
            </div>
            <div class="col-md-6 form-group mt-3">
            <input class="form-control" type="text" name="jobtitle" placeholder="Guest Service Associate - Radisson Hotel Kandla">
            </div>
        </div>
            <input class="form-control mt-3" type="text" name="joblocation" placeholder="Mahabaleshwar"> <br>
