        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../../forms/partnerContactForm/partner.php">PARTNERS</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <section class="home pt-5">
        ...
        <div class="container">
            <div class="section-title pt-2">
                ...
                <p>Whether you are an international or domestic brand looking to expand your footprint or whether you
                    are a reputed owner/developer, drop in an enquiry to us below on how we can assist you and make your
                    journey towards accomplishing your goals that much easier.</p>
            </div>
        ...
        <div class="section-title pt-2">
                    ...
                    <div class="container">
                        ...
                        <form action="sendPartnerContact.php" method="post" class="php-email-form mx-5">
                            <div class="row">
                            ...
                            <div class="form-group mt-3">
                                <textarea class="form-control" rows="5" name = "msgbody" id="msgbody"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-lg-4 footer-about wow fadeInUp">
                        <img class="logo-footer" src="../../assets/img/LOGO-1.png" alt="logo-footer"
                            data-at2x="assets/img/LOGO-1.png">
                        <p>
                            Hotels worldwide incl. Infos, Ratings and Photos. Make your Hotel Reservation cheap. <br>The
                            top-rated hotel booking services.
                        </p>
                        <p><a href="#">Our Team</a></p>
                    </div>
                    <div class="col-md-4 col-lg-4 offset-lg-1 footer-contact wow fadeInDown">
                        <h3>Contact</h3>
                        <p><i class="fa fa-map-marker"></i> Corporate office :- Manjari bk, Phursungi Phata, Pune -
                            412307<br>
                            Branch office :- 396/191 Moo 12, Pratyumnk, Nongprue, Banglamung, Chonburi (Pattaya),
                            Thailand - 20150</p>
                        <p><i class="fa fa-phone"></i> Phone: +91 9922-972-137</p>
